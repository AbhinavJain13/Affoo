...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tActionSkip = (TextView) findViewById(R.id.action_skip);
        tActionSkip.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                openDrawer();
            }
        ...
        mEmailView = (AutoCompleteTextView) findViewById(R.id.customer_email);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            //createUserWithEmailAndPassword(mAuth);
